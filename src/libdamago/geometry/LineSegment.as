...
public class LineSegment
{
    ...
    public static function distanceLineSegments (p1 :Vector2, p2 :Vector2, p3 :Vector2, p4 :Vector2, pa :Vector2, pb :Vector2) :Number
    {
        trace("p1=" + p1);
        trace("p2=" + p2);
        trace("p3=" + p3);
...
//        return dx * dx +  dy * dy;
    ...
    {
        return (A.equals(E) && !B.equals(F)) || (!A.equals(E) && B.equals(F))
            || (A.equals(F) && !B.equals(E)) || (!A.equals(F) && B.equals(E))
    }
...
//    }
    ...
    {
        return Math.min(distToLineSegmentSq(a, b, line.a),
                        distToLineSegmentSq(a, b, line.b),
                        distToLineSegmentSq(line.a, line.b, a),
                        distToLineSegmentSq(line.a, line.b, b));
    }
    ...
    public function intersectionPointLinePoints (v1 :Vector2, v2 :Vector2, as_seg :Boolean = true) :Vector2
    {
