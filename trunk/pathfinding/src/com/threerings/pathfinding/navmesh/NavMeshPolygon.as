...
public class NavMeshPolygon extends Polygon
    implements Hashable
{
    private static var CURRENT_HASH :int = 0;
    protected var _hash :int = ++CURRENT_HASH;
    ...
    public function NavMeshPolygon (vertices :Array, movementCost :Number = 1000,
    ...
    public static function fromRect (x :Number, y :Number, width :Number, height :Number,
        movementCost :Number = 10000, padOuter :Boolean = false) :NavMeshPolygon
    {
    ...
    {
        return (other is NavMeshPolygon) && (_hash === (other as NavMeshPolygon)._hash);
    }

    override public function clone () :Polygon
    {
        var navPolygon :NavMeshPolygon =
            new NavMeshPolygon(_vertices.map(F.adapt(function (v :Vector2) :Vector2 {
    ...
    public function sharesVertex (polygon :NavMeshPolygon) :Boolean
    {
    ...
    public function getSharedVertices (polygon :NavMeshPolygon) :Array
    {
...
//    }
    ...
    public function compare (navPolygon :NavMeshPolygon) :Boolean
    {
    ...
    public function getAllEdgeMidpointsAsPolygon () :Polygon
    {
        ...
        return new NavMeshPolygon(midPoints);
    }
    ...
    */
    public static function horizontalMidPoint (P1 :NavMeshPolygon, P2 :NavMeshPolygon) :Number
    {
    ...
    * Not defined if the polygons overlap.
    */
    public static function verticalMidPoint (P1 :NavMeshPolygon, P2 :NavMeshPolygon) :Number
    {
