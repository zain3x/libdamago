...
import net.amago.pathfinding.navmesh.NavMeshPathFinder;
...
public class TestNavigationMeshPathfinding extends AppMode
{
    ...
    protected static function drawNavMesh(meshSprite :Sprite, navmesh :NavMesh, path :PathToFollow, start :Vector2, target :Vector2) :void
    {
        ...
        NavmeshUtil.drawGrid(meshSprite.graphics, 100, 0xff9999);
...
//        }
        ...
        function drawNode(node :NavMeshNode, sprite :Sprite) :void
        {
            ...
            for each(var neighbour :NavMeshNode in node.getNeighbors()) {
                var nodePairKey :int = NavmeshUtil.hashForIdPair(node.hashCode(), neighbour.hashCode());
                if(!drawnNodePairs.contains(nodePairKey)) {
                    ...
                    if(!mesh._distances.containsKey(NavmeshUtil.hashForIdPair(node._id, neighbour._id))) {
                        distanceLabel.text = "        X";
                    }
                    else {
                        distanceLabel.text = "" + int(mesh._distances.get(NavmeshUtil.hashForIdPair(node._id, neighbour._id)));
                    }
    ...
    protected function navTest12 (meshSprite :Sprite) :void
    {
        ...
        terrain.push(NavMeshPolygonExclusion.fromRect(350, 420, 100, 350));
    ...
    protected function navTest6 (meshSprite :Sprite) :void
    {
        ...
        terrain.push(NavMeshPolygonExclusion.fromRect(-10, 200, 600, 20));
        terrain.push(NavMeshPolygonExclusion.fromRect(390, 380, 80, 10));
        terrain.forEach(Util.adapt(pathfinder.addNavMeshPolygon));
    ...
    protected function navTest16 (meshSprite :Sprite) :void
    {
        ...
        terrain.push(NavMeshPolygonExclusion.fromRect(-10, 200, 600, 20));
        terrain.push(NavMeshPolygonExclusion.fromRect(400, 385, 80, 10));
        terrain.forEach(Util.adapt(pathfinder.addNavMeshPolygon));
    ...
    //            terrain.push(NavMeshPolygon.fromRect(400, 200, 500, 20));
        terrain.push(NavMeshPolygonExclusion.fromRect(0, 300, 500, 20));
        terrain.forEach(Util.adapt(pathfinder.addNavMeshPolygon));
    ...
    protected function navTest8 (meshSprite :Sprite) :void
    {
        ...
        var terrain :Array = new Array();
        terrain.push(NavMeshPolygonExclusion.fromRect(850, 350, 800, 50));
        terrain.push(NavMeshPolygonExclusion.fromRect(500, 350, 40, 350));
        terrain.forEach(Util.adapt(pathfinder.addNavMeshPolygon));
...
//        var target :Vector2 = new Vector2(300, 100);
        ...
        terrain.push(NavMeshPolygonExclusion.fromRect(300, 450, 300, 60));
        terrain.push(NavMeshPolygonExclusion.fromRect(300, 250, 100, 30));
        terrain.forEach(Util.adapt(pathfinder.addNavMeshPolygon));
...
//        terrain.push(NavMeshPolygon.fromRect(200, 200, 100, 200, 60));
        terrain.push(new NavMeshPolygonExclusion([
//                                        new Vector2(200, 200),
//                                        new Vector2(400, 200),
//                                        new Vector2(400, 400),
//                                        new Vector2(200, 400),
...
//        trace(terrain);
    ...
    protected function navTest9 (meshSprite :Sprite) :void
    {
        ...
        terrain.push(NavMeshPolygonExclusion.fromRect(BOARD_SIZE.x - 200, BOARD_SIZE.y - 100, width, 60));
        terrain.push(NavMeshPolygonExclusion.fromRect(200, BOARD_SIZE.y - 100, width, 60));
        terrain.forEach(Util.adapt(pathfinder.addNavMeshPolygon));
    ...
    protected function navTest10 (meshSprite :Sprite) :void
    {
        ...
        terrain.push(NavMeshPolygonExclusion.fromRect(riverHalfLength/2, BOARD_SIZE.y/3, riverHalfLength, 50));
        terrain.push(NavMeshPolygonExclusion.fromRect(BOARD_SIZE.x - riverHalfLength / 2, BOARD_SIZE.y/3, riverHalfLength, 50));
        terrain.forEach(Util.adapt(pathfinder.addNavMeshPolygon));
    ...
    protected function navTest4 (meshSprite :Sprite) :void
    {
        ...
        var terrain :Array = new Array();
        terrain.push(NavMeshPolygonExclusion.fromRect(300, 300, 300, 300));
        terrain.push(NavMeshPolygonExclusion.fromRect(300, 300, 100, 100));
        terrain.forEach(Util.adapt(pathfinder.addNavMeshPolygon));
    ...
    protected function navTest13 (meshSprite :Sprite) :void
    {
        ...
        terrain.push(NavMeshPolygonExclusion.fromRect(300, 300, 300, 300));
        terrain.push(NavMeshPolygonExclusion.fromRect(500, 500, 100, 100));
        terrain.forEach(Util.adapt(pathfinder.addNavMeshPolygon));
    ...
    protected function navTest2 (meshSprite :Sprite) :void
    {
        ...
        terrain.push(NavMeshPolygonExclusion.fromRect(-10, 200, 500, 20));
        terrain.push(NavMeshPolygonExclusion.fromRect(600, 400, 600, 20));
        terrain.push(NavMeshPolygonExclusion.fromRect(-10, 600, 600, 20));
        terrain.push(NavMeshPolygonExclusion.fromRect(800, 800, 1000, 20));
        terrain.forEach(Util.adapt(pathfinder.addNavMeshPolygon));
    ...
    protected function navTest11 (meshSprite :Sprite) :void
    {
        ...
        terrain.push(NavMeshPolygonExclusion.fromRect(-10, 200, 600, 20));
        terrain.push(NavMeshPolygonExclusion.fromRect(800, 400, 1000, 20));
        terrain.forEach(Util.adapt(pathfinder.addNavMeshPolygon));
    ...
    protected static function scenario1 () :Array//Bridge over river
    {
        ...
        var riverHalfLength :Number = (BOARD_SIZE.x / 2) - (riverMouthWidth / 2);
        terrain.push(NavMeshPolygonExclusion.fromRect(riverHalfLength/2, BOARD_SIZE.y/2, riverHalfLength, 50));
        terrain.push(NavMeshPolygonExclusion.fromRect(BOARD_SIZE.x - riverHalfLength / 2, BOARD_SIZE.y/2, riverHalfLength, 50));
        return terrain;
    }
    ...
    {
        var terrain :Array = new Array();
        terrain.push(NavMeshPolygonExclusion.fromRect(BOARD_SIZE.x / 2, BOARD_SIZE.y / 2, 250, 150));
        return terrain;
    }
